...
<div class="settings-container">
    ...
    <!-- ============================================================ -->
    <!-- BODY - 1 KOLOM (MANAJEMEN PERANGKAT SAJA)                      -->
    <!-- ============================================================ -->
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-xl-10 col-lg-12 col-md-12">
            ...
            <div class="settings-card">
                <div class="card-title">
                    <span class="title-left">
                        <i class="fas fa-server"></i> Manajemen Perangkat
                    </span>
                    <a href="{{ route('pins.index') }}" class="btn-edit">
                ...
                <div style="overflow-x: auto;">
                    <table class="table-modern" style="width:100%;">
                        ...
                        <tbody>
                            <tr>
                                <td><strong>Status Koneksi</strong></td>
                                <td>
                                    <span class="badge-mini {{ $deviceOnline ? 'badge-mini-success' : 'badge-mini-danger' }}">
                                        {{ $deviceOnline ? '✅ Terhubung' : '❌ Terputus' }}
                                    </span>
                                    <small class="text-muted ms-2" style="font-size: 0.75rem;">
                                        {{ $deviceOnline ? 'Mesin absensi dapat diakses' : 'Periksa koneksi internet dan API Key' }}
                                    </small>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    @php
                                        $pins = App\Models\Pin::where('is_active', true)->get();
                                    @endphp
                                    <strong>{{ $pins->count() }}</strong> perangkat aktif
                                    <a href="{{ route('pins.index') }}" class="text-decoration-none ms-2" style="font-size: 0.8rem; color: #6366F1;">
                                        Kelola →
                                    </a>
                                </td>
                            </tr>
                ...
                <div>
                    <h6 style="font-size: 0.65rem; text-transform: uppercase; letter-spacing: 0.05em; color: #6B7280; margin-bottom: 12px;">
                        <i class="fas fa-plus-circle me-1"></i> Tambah Mesin Absensi Baru
                    </h6>
                    <form action="{{ route('settings.add-device') }}" method="POST">
                        @csrf
                        <div class="row g-2">
                            <div class="col-md-6">
                                <label class="form-label-modal" style="font-size: 0.8rem; margin-bottom: 4px;">Cloud ID *</label>
                                <input type="text" name="pin" class="form-control-modal" placeholder="Contoh: ABC123XYZ" required>
                                <small class="text-muted" style="font-size: 0.7rem;">ID Cloud dari Fingerspot</small>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-modal" style="font-size: 0.8rem; margin-bottom: 4px;">Nama Perangkat *</label>
                                <input type="text" name="device_name" class="form-control-modal" placeholder="Contoh: Mesin Kantor Pusat" required>
                                <small class="text-muted" style="font-size: 0.7rem;">Nama untuk identifikasi</small>
                            </div>
                            <div class="col-md-12 mt-2">
                                <button type="submit" class="btn-custom btn-custom-primary btn-custom-sm">
